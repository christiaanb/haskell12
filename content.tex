...
Each \emph{node} represents a physical computing object: such as a core, \olcomment{a} complete CPU, \olcomment{a} memory controller, etc.
...
Having both explicit messaging and shared memories,\olcomment{memory or memories?} \soosim supports the two well known methods of communication.
