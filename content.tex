...
Several simulator ticks might pass before the % callee sends a
response.
...
Components have two unique identifiers, their global \emph{name} (as specified in the \hs{CompIface} instance), and a \hs{ComponentId} that
...
For the sake of the implementation of ...... we embedded a DSL in Haskell. \olcomment{FIX the explanation!}
...
\citeauthor{final_tagless_embedding} implement DSLs for higher-order languages, while \citeauthor{Hofer:2008:PED:1449913.1449935} focus on the possibility to plug in multiple implementations of an embedded DSL. \olcomment{pure embedded DSL, it if matters}

\olcomment{cite: P. Hudak. Building domain-specific embedded languages. ACM Comput. Surv., 28(4), 1996.}
\olcomment{cite: P. Hudak. Modular domain specific languages and tools. In P. Devanbu and J. Poulin, editors, Proceedings: Fifth International Conference on Software Reuse, pages 134–142. IEEE Computer Society Press, 1998. for pure embedding}
...
Examples of fruitful combinations of STM \olcomment{dirty style. either introduce properly or remove the acronym!} with other concepts include papers by \citeauthor{Harris:2008:CMT:1378704.1378725} \cite{Harris:2008:CMT:1378704.1378725} and \citeauthor{Bieniusa:2010:BAA:1835698.1835714} \cite{Bieniusa:2010:BAA:1835698.1835714}.
