...
Aforementioned ideas were the motivation for the S(o)OS project \cite{soos}.
...
While creating of new operating system concepts and regarding their interaction with the programmability of large-scale systems, we found that existing simulation packages do not seem to have the right abstractions for fast design exploration \cite{cotson,omnet}.
...
...
\end{code}
\olcomment{Can we hide the \cd{Dynamic} somehow?}
