...
The simulator monad \hs{SimM} is described in Figure \olcomment{.....}
The user-defined internal \hs{State} can be used to store any
...
simulator to process the response.  Unlike \hs{invoke}, using this
