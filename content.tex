...
A note on blocking messaging: when a blocking message is sent, the sender waits for the answer---regardless \emph{where} in the code of the sender the blocking \hs{invoke} method is called.
