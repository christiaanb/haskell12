...
%format <- = "\ensuremath{\in}"
%format <-- = "\ensuremath{\leftarrow}"
...
\author{Oleg Lobachev\inst{1} \and Christiaan Baaij\inst{2} \and Jan
  Kuper\inst{2} \and Juri Lelli\inst{1} \and Giuseppe~Lipari\inst{1,3}} 
\tocauthor{Oleg Lobachev, Christiaan Baaij, Jan Kuper, Juri Lelli, and
  Giuseppe Lipari}


\institute{Scuola Superiore Sant'Anna, Pisa, Italy\\
  \email{\{\href{mailto:o.lobachev@@sssup.it}{o.lobachev},
    \href{mailto:j.lelli@@sssup.it}{j.lelli},
    \href{mailto:g.lipari@@sssup.it}{g.lipari}\}@@sssup.it} 
  %\email{first.last@@sssup.it}
  \and
  University of Twente, Twente, Netherlands\\
  \email{\{\href{mailto:c.p.r.baaij@@utwente.nl}{c.p.r.baaij},
  \href{mailto:j.kuper@@utwente.nl}{j.kuper}\}@@utwente.nl}
\and
École Normale Supérieure de Cachan, Cachan, France\\
%ENS de Cachan, Cachan, France\\
\email{\href{mailto:giuseppe.lipari@@lsv.ens-cachan.fr}{giuseppe.lipari@@lsv.ens-cachan.fr}}
}
