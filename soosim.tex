...
\newcommand{\bind}{\textsf{$\gg$=}\xspace}
...
These include coroutines, type classes, monads, techniques for embedded domain-specific languages, and dynamic types. \olcomment{remove "dynamic types" in case of a success?}
